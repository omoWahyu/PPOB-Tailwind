	...
	<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable relative w-auto pointer-events-none">
		<div class="modal-content border-none shadow-lg relative flex flex-col w-full pointer-events-auto bg-white dark:bg-slate-900 bg-clip-padding rounded-md outline-none text-current">
			<div class="modal-header flex flex-shrink-0 items-center justify-between p-4 border-b border-gray-200 rounded-t-md">
				<h5 class="text-xl font-medium leading-normal text-gray-800 dark:text-white" id="registrasiLabel">
				Registrasi Akun
				</h5>
				<button type="button"
			...
			<form action="<?=base_url('user/register')?>" method="post" class="modal-body relative p-4">
				<div class="form-floating mb-3 ">
					<input  type="text" name="nama_pelanggan" required="required" class="form-control block w-full px-3 text-base font-normal text-gray-700 bg-gray-200  dark:bg-slate-200 bg-clip-padding border dark:border-0 rounded-lg transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 dark:focus:text-slate-700 dark:focus:bg-white dark:focus:border-blue-600 focus:outline-none" 
				...
				<div class="grid grid-cols-2 gap-4">
					<div class="form-floating mb-3 ">
						<input type="number" name="nomor_kwh" required="required" class="form-control block w-full px-3 text-base font-normal text-gray-700 bg-gray-200  dark:bg-slate-200 bg-clip-padding border dark:border-0 rounded-lg transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 dark:focus:text-slate-700 dark:focus:bg-white dark:focus:border-blue-600 focus:outline-none" 
							id="nomor_kwh" placeholder="John Doe" value="1200">
						<label for="nomor_kwh" class="text-gray-700">No Kwh</label>
					</div>
					<select class="form-select appearance-none block w-full px-2 py-1 mb-3 font-normal bg-no-repeat text-gray-700 bg-gray-200  dark:bg-slate-200 bg-clip-padding border dark:border-0 rounded-lg transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 dark:focus:text-slate-700 dark:focus:bg-white dark:focus:border-blue-600 focus:outline-none"
				...
				<div class="form-floating mb-3 ">
					<textarea name="alamat" required="required" cols="30" rows="10" class="form-control block w-full px-3 text-base font-normal text-gray-700 bg-gray-200  dark:bg-slate-200 bg-clip-padding border dark:border-0 rounded-lg transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 dark:focus:text-slate-700 dark:focus:bg-white dark:focus:border-blue-600 focus:outline-none" 
						id="alamat" placeholder="John Doe"></textarea>
					<label for="alamat" class="text-gray-700 dark:text-gray-300">Alamat</label>
				</div>

				<div class="grid grid-cols-2 gap-4">
					<div class="form-floating mb-3 ">
						<input  type="text" name="username" required="required" class="form-control block w-full px-3 text-base font-normal text-gray-700 bg-gray-200  dark:bg-slate-200 bg-clip-padding border dark:border-0 rounded-lg transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 dark:focus:text-slate-700 dark:focus:bg-white dark:focus:border-blue-600 focus:outline-none" 
							id="username" placeholder="John Doe">
						<label for="username" class="text-gray-700">Username</label>
					</div>
					<div class="form-floating mb-3 ">
						<input type="password" id="sp1" name="password" required="required" class="form-control block w-full px-3 text-base font-normal text-gray-700 bg-gray-200  dark:bg-slate-200 bg-clip-padding border dark:border-0 rounded-lg transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 dark:focus:text-slate-700 dark:focus:bg-white dark:focus:border-blue-600 focus:outline-none" 
				...
				<div class="form-check mb-3">
					...
					<label class="form-check-label inline-block text-gray-800 dark:text-gray-300 -mb-1" for="FP1">
						Lihat Password
					</label>
				</div>
